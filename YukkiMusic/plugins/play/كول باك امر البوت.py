...
@app.on_callback_query(filters.regex("madithkm"))
async def fft(_, query: CallbackQuery):
   await query.edit_message_text(
       f"""[ٓ❍ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 𝐋𝐮𝐫𝐚 .](https://t.me/so_alfaa)\n\n•═════•| 𝙻𝚞𝚛𝚊 |•═════•\n\nمرحبا بك عزيزي ف قسم اوامر تحكم البوت .\n\n قائمه التحكم تحتوي علي 6 اوامر .\n\n•═════•| 𝙻𝚞𝚛𝚊 |•═════•\n\n1 : اوامر التشغيل .\n\n2 : اوامر القنوات .\n\n3 : اوامر مطور البوت .\n\n4 : مميزات السورس .\n\n5 : اوامر البوت .\n\n6 : اوامر الادمن .""",
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "࿈ اوامر التشغيل .", callback_data=f"madi1"),
                    InlineKeyboardButton(
                        "࿈ اوامر القنوات .", callback_data=f"madi2"),
                ],[
                    InlineKeyboardButton(
                        "࿈ اوامر مطور البوت .", callback_data=f"madi3"),
                    InlineKeyboardButton(
                        "࿈ مميزات السورس .", callback_data=f"madi4"),
                ],[
                    InlineKeyboardButton(
                        "࿈ اوامر البوت .", callback_data=f"madi5"),
                    InlineKeyboardButton(
                        "࿈ اوامر الادمن .", callback_data=f"madi6"),
                ],[
                    InlineKeyboardButton(
...
@app.on_callback_query(filters.regex("madi5"))
async def fft(_, query: CallbackQuery):
   await query.edit_message_text(
       f"""[ٓ❍ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 𝐋𝐮𝐫𝐚 .](https://t.me/so_alfaa)\n\n•═════•| 𝙻𝚞𝚛𝚊 |•═════•\n✅ اليك قائمة اوامر البوت ,\n•═════•| 𝙻𝚞𝚛𝚊 |•═════•\n- لعرض سرعه البوت اكتب : بينج .\n- للتحكم في لغه البوت اكتب : اللغه .\n- للتحكم في ازار التشغيل اكتب : وضع شغل .\n- لعرض اعدادات البوت اكتب : الاعدادات .\n\n- ثانيا اليك اوامر الرتب .\n•═════•| 𝙻𝚞𝚛𝚊 |•═════•\n- لرفع ادمن في الجروب اكتب : ر ا د .\n- لرفع ادمن في الجروب اكتب : ت ا د .\n- لعرض قائمه الادمنيه اكتب : ق ا د .\n- لرفع مطور ثانوي اكتب : ر م ث .\n- لتنزيل مطور ثانوي اكتب : ت م ث .\n- لعرض قائمه الثانوين اكتب : ق م ث .\n\n- ثالثا اليك اوامر الحظر .\n•═════•| 𝙻𝚞𝚛𝚊 |•═════•\n- لحظر عضو من الجروب اكتب : ح ر .\n- لالغاء حظر عضو من الجروب اكتب : ا ر .\n- لعرض قائمه المحظورين اكتب : ق ح ر .\n- لحظر عضو عام من الجروب اكتب : ح ع .\n- لالغاء حظر عضو عام من الجروب اكتب : ا ر .\n- لعرض قائمه المحظورين عام اكتب : ق ح ع .""",       reply_markup=InlineKeyboardMarkup(
          [
               [
                    ...
                    InlineKeyboardButton(
                        "‹ رجوع ›", callback_data="madithkm"),
                    InlineKeyboardButton(
                        "‹ القائمة الرئيسية ›", callback_data="settingsback_helper"),
                ],[
                    InlineKeyboardButton(
                        "࿈ ᥉᥆υɾᥴᥱ ᥣυɾᥲ️ .", url=f"https://t.me/so_alfaa"),
...
@app.on_callback_query(filters.regex("madi6"))
async def fft(_, query: CallbackQuery):
   await query.edit_message_text(
...
@app.on_callback_query(filters.regex("madi4"))
async def fft(_, query: CallbackQuery):
   await query.edit_message_text(
...
@app.on_callback_query(filters.regex("madi2"))
async def fft(_, query: CallbackQuery):
   await query.edit_message_text(
...
@app.on_callback_query(filters.regex("madi3"))
async def fft(_, query: CallbackQuery):
   await query.edit_message_text(
...
@app.on_callback_query(filters.regex("madi1"))
async def fft(_, query: CallbackQuery):
   await query.edit_message_text(
